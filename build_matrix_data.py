...
PLAYER_STAT_CATALOG = [
    # -- Attacking --
    {"key": "goals", "abbr": "G", "label": "Goals", "category": "attacking", "cols": ["Goal"]},
    {"key": "assists", "abbr": "A", "label": "Assists", "category": "attacking", "cols": ["Assist"]},
    {"key": "gc", "abbr": "GC", "label": "Goal Contributions", "category": "attacking", "cols": ["Goal", "Assist"]},
    {"key": "xG", "abbr": "xG", "label": "xG", "category": "attacking", "cols": ["xG"]},
    {"key": "xA", "abbr": "xA", "label": "xA", "category": "attacking", "cols": ["xA"]},
    {"key": "shotsTotal", "abbr": "SH", "label": "Total Shots", "category": "attacking", "cols": ["Shot Total"]},
    {"key": "shotsOn", "abbr": "SOT", "label": "Shots On", "category": "attacking", "cols": ["Goal", "Shot Saved"]},
    {"key": "shotsOff", "abbr": "SOFF", "label": "Shots Off", "category": "attacking", "cols": ["Shot Off Target"]},
    {"key": "shotsBlocked", "abbr": "SHB", "label": "Shots Blocked", "category": "attacking", "cols": ["Shot Blocked"]},
    {"key": "shotAssist", "abbr": "SHA", "label": "Shot Assists", "category": "attacking", "cols": ["Shot Assist"]},
    {"key": "shotContribution", "abbr": "SHC", "label": "Shot Contribution", "category": "attacking", "cols": ["Shot Contribution"]},
    {"key": "keyPass", "abbr": "KP", "label": "Key Passes", "category": "attacking", "cols": ["Key pass"]},
    {"key": "cornerEarned", "abbr": "CE", "label": "Corners Earned", "category": "attacking", "cols": ["Corner Earned"]},
    {"key": "dzEntries", "abbr": "DZE", "label": "DZ Entries", "category": "attacking",
     "cols": ["DZ Dribble", "DZ Pass", "DZ Cross", "DZ Set Piece", "DZ Shot", "DZ Regain"]},  # == DZ_ENTRY_COLS (defined later, near MATCH_FLOW_WEIGHTS)
    {"key": "dzDribble", "abbr": "DZDR", "label": "DZ Dribbles", "category": "attacking", "cols": ["DZ Dribble"]},
    {"key": "dzPass", "abbr": "DZP", "label": "DZ Passes", "category": "attacking", "cols": ["DZ Pass"]},
    {"key": "dzCross", "abbr": "DZCR", "label": "DZ Crosses", "category": "attacking", "cols": ["DZ Cross"]},
    {"key": "dzSetPiece", "abbr": "DZSP", "label": "DZ Set Pieces", "category": "attacking", "cols": ["DZ Set Piece"]},
    {"key": "dzShot", "abbr": "DZSH", "label": "DZ Shots", "category": "attacking", "cols": ["DZ Shot"]},
    {"key": "entryPassTo9", "abbr": "EP9", "label": "Entry Pass to 9", "category": "attacking", "cols": ["Entry Pass to 9"]},
    {"key": "crossSuccessful", "abbr": "CR+", "label": "Crosses Successful", "category": "attacking", "cols": ["Cross Successful"]},
    {"key": "crossUnsuccessful", "abbr": "CR-", "label": "Crosses Unsuccessful", "category": "attacking", "cols": ["Cross Unsuccessful"]},
    {"key": "faceUp", "abbr": "FU", "label": "Face Ups", "category": "attacking", "cols": ["Face up"]},
    {"key": "win2", "abbr": "W+2", "label": "Win+2", "category": "attacking", "cols": ["Win2"]},
    {"key": "creativeAction", "abbr": "CA", "label": "Creative Actions", "category": "attacking", "cols": ["Creative Action"]},
    {"key": "firstContact", "abbr": "FC", "label": "First Contact (SP)", "category": "attacking", "cols": ["First Contact on SP"]},
    {"key": "switch", "abbr": "SW", "label": "Switches", "category": "attacking", "cols": ["Switch"]},
    {"key": "foulEarned", "abbr": "FE", "label": "Fouls Earned", "category": "attacking", "cols": ["Foul Earned"]},
    {"key": "penaltyEarned", "abbr": "PKE", "label": "Penalties Earned", "category": "attacking", "cols": ["Penalty Earned"]},
    {"key": "offside", "abbr": "OFF", "label": "Offsides", "category": "attacking", "cols": ["Offside"]},
    # -- Defending --
    {"key": "interceptions", "abbr": "INT", "label": "Interceptions", "category": "defending", "cols": ["Interceptions"]},
    {"key": "tackle", "abbr": "TKL", "label": "Tackles", "category": "defending", "cols": ["Tackle"]},
    {"key": "defChallengeSuccessful", "abbr": "DC+", "label": "Def Challenges Won", "category": "defending", "cols": ["Def Challenge Successful"]},
    {"key": "defChallengeUnsuccessful", "abbr": "DC-", "label": "Def Challenges Lost", "category": "defending", "cols": ["Def Challenge Unsuccessful"]},
    {"key": "defContrib", "abbr": "DEF", "label": "Defensive Contribution", "category": "defending",
     "cols": ["Interceptions", "Def Challenge Successful"]},
    {"key": "clSecured", "abbr": "CLS", "label": "Clearances Secured", "category": "defending", "cols": ["CL Secured"]},
    {"key": "clSuccessful", "abbr": "CL+", "label": "Clearances Successful", "category": "defending", "cols": ["CL Successful"]},
    {"key": "clUnsuccessful", "abbr": "CL-", "label": "Clearances Unsuccessful", "category": "defending", "cols": ["CL Unsuccessful"]},
    {"key": "bsSuccessful", "abbr": "BS+", "label": "Block Shots Successful", "category": "defending", "cols": ["BS Successful"]},
    {"key": "bsUnsuccessful", "abbr": "BS-", "label": "Block Shots Unsuccessful", "category": "defending", "cols": ["BS Unsuccessful"]},
    {"key": "bcSuccessful", "abbr": "BC+", "label": "Block Crosses Successful", "category": "defending", "cols": ["BC Successful"]},
    {"key": "bcUnsuccessful", "abbr": "BC-", "label": "Block Crosses Unsuccessful", "category": "defending", "cols": ["BC Unsuccessful"]},
    {"key": "dzDefending", "abbr": "DZD", "label": "DZ Defending", "category": "defending",
     "cols": ["CL Secured", "CL Successful", "BS Successful", "BC Successful"]},
    {"key": "doubleDown", "abbr": "DD", "label": "Double Downs", "category": "defending", "cols": ["Double Down"]},
    {"key": "headerSuccessful", "abbr": "HD+", "label": "Headers Won", "category": "defending", "cols": ["Header Successful"]},
    {"key": "headerUnsuccessful", "abbr": "HD-", "label": "Headers Lost", "category": "defending", "cols": ["Header Unsuccessful"]},
    {"key": "foulConceded", "abbr": "FLC", "label": "Fouls Conceded", "category": "defending", "cols": ["Foul Conceded"]},
    {"key": "defFoulConceded", "abbr": "DFC", "label": "Def Half Fouls Conceded", "category": "defending", "cols": ["Def Foul Conceded"]},
    {"key": "professionalFoul", "abbr": "PROF", "label": "Professional Fouls", "category": "defending", "cols": ["Professional Foul"]},
    {"key": "penaltyConceded", "abbr": "PKC", "label": "Penalties Conceded", "category": "defending", "cols": ["Penalty Conceded"]},
    {"key": "yellow", "abbr": "YC", "label": "Yellow Cards", "category": "defending", "cols": ["Yellow"]},
    {"key": "red", "abbr": "RC", "label": "Red Cards", "category": "defending", "cols": ["Red"]},
    {"key": "cleansheets", "abbr": "CS", "label": "Clean Sheets", "category": "defending", "cols": ["Cleansheet"]},
    # -- Transition --
    {"key": "regainAttHalf", "abbr": "AHR", "label": "Att Half Regains", "category": "transition", "cols": ["Regain Att Half"]},
    {"key": "lostBallsOwnHalf", "abbr": "LBO", "label": "Lost Balls (Own Half)", "category": "transition", "cols": ["Lost balls own half"]},
    {"key": "secondBall", "abbr": "2ND", "label": "Second Balls", "category": "transition", "cols": ["Second Ball"]},
    {"key": "attFoulEarned", "abbr": "AFE", "label": "Att Half Fouls Earned", "category": "transition", "cols": ["Att Foul Earned"]},
    {"key": "badGiveaway", "abbr": "BG", "label": "Bad Giveaways", "category": "transition", "cols": ["Bad Giveaway"]},
    {"key": "securanceSuccessful", "abbr": "SEC+", "label": "Securance Successful", "category": "transition", "cols": ["Securance Successful"]},
    {"key": "securanceUnsuccessful", "abbr": "SEC-", "label": "Securance Unsuccessful", "category": "transition", "cols": ["Securance Unsuccessful"]},
    {"key": "attChallengeSuccessful", "abbr": "AC+", "label": "Att Challenges Won", "category": "transition", "cols": ["Att Challenge Successful"]},
    {"key": "attChallengeUnsuccessful", "abbr": "AC-", "label": "Att Challenges Lost", "category": "transition", "cols": ["Att Challenge Unsuccessful"]},
    ...
    {"key": "physTopSpeed", "abbr": "SPD", "label": "Avg Top Speed", "category": "physical", "cols": None},
    {"key": "physHiRatio", "abbr": "HI%", "label": "Hi-Intensity Ratio", "category": "physical", "cols": None},
    {"key": "physDistP90", "abbr": "DIST", "label": "Distance", "category": "physical", "cols": None},
    {"key": "physLoad", "abbr": "LOAD", "label": "Load", "category": "physical", "cols": ["Load"]},
    {"key": "physJumps", "abbr": "JMP", "label": "Jumps", "category": "physical", "cols": ["Jumps"]},
    {"key": "physDives", "abbr": "DIV", "label": "Dives", "category": "physical", "cols": ["Dives"]},
]
...
def build_squad_table(match_xlsx_path, lookup_xlsx_path):
    ...
    return {
        ...
        "catalog": [{"key": s["key"], "label": s["label"], "abbr": s["abbr"], "category": s["category"]}
...
STAT_CATALOG = [
    # -- Attacking (19) --
    ("goals", "Goals", "G", "attacking", "stats"),
    ("xG", "xG", "xG", "attacking", "stats"),
    ("shotsTotal", "Total Shots", "SH", "attacking", "stats"),
    ("shotsOn", "Shots On", "SOT", "attacking", "stats"),
    ("shotsOff", "Shots Off", "SOFF", "attacking", "stats"),
    ("shotsBlocked", "Shots Blocked", "SHB", "attacking", "stats"),
    ("corners", "Corners", "COR", "attacking", "stats"),
    ("throwInPct", "Throw-Ins %", "TI%", "attacking", "stats"),
    ("dzEntries", "DZ Entries", "DZE", "attacking", "stats"),
    ("dzDribble", "DZ Dribbles", "DZDR", "attacking", "objectives"),
    ("dzPass", "DZ Passes", "DZP", "attacking", "objectives"),
    ("dzCross", "DZ Crosses", "DZCR", "attacking", "objectives"),
    ("dzSetPiece", "DZ Set Pieces", "DZSP", "attacking", "objectives"),
    ("dzShot", "DZ Shots", "DZSH", "attacking", "objectives"),
    ("faceUp", "Face Ups", "FU", "attacking", "objectives"),
    ("win2", "Win+2", "W+2", "attacking", "objectives"),
    ("creativeActions", "Creative Actions", "CA", "attacking", "objectives"),
    ("firstContact", "First Contact", "FC", "attacking", "objectives"),
    ("switches", "Switches", "SW", "attacking", "objectives"),
    # -- Defending (9) --
    ("saves", "Saves", "SV", "defending", "stats"),
    ("clearances", "Clearances", "CLR", "defending", "objectives"),
    ("blockShots", "Block Shots", "BS", "defending", "objectives"),
    ("blockCrosses", "Block Crosses", "BC", "defending", "objectives"),
    ("doubleDowns", "Double Downs", "DD", "defending", "objectives"),
    ("professionalFouls", "Professional Fouls", "PROF", "defending", "objectives"),
    ("foulsConceded", "Fouls", "FLC", "defending", "stats"),
    ("yellow", "Yellow", "YC", "defending", "stats"),
    ("red", "Red", "RC", "defending", "stats"),
    # -- Transition (5) --
    ("ropDzEntries", "RoP DZ Entries", "RDZE", "transition", "stats"),
    ("secondBalls", "Second Balls", "2ND", "transition", "objectives"),
    ("attHalfRegain", "Att Half Regain", "AHR", "transition", "objectives"),
    ("defHalfLostBall", "Def Half Lost Ball", "DHL", "transition", "objectives"),
    ("attHalfFoulsEarned", "Att Half Fouls Earned", "AFE", "transition", "objectives"),
    # -- Physical (3, new 2026-09-15 -- UNCW-only, no opponent GPS data) --
    ("physTeamDist", "Team Distance", "DIST", "physical", "physical"),
    ("physTeamTopSpeed", "Team Avg Top Speed", "SPD", "physical", "physical"),
    ("physTeamHiRatio", "Team Hi-Intensity Ratio", "HI%", "physical", "physical"),
]
...
def build_stats_table(match_center, match_xlsx_path):
    ...
    for m in match_center["matches"]:
        if not m.get("played") or "stats" not in m:
            continue
        values = {}
        for key, label, abbr, category, source in STAT_CATALOG:
            if source == "stats":
    ...
    return {
        ...
        "catalog": [{"key": k, "label": l, "abbr": a, "category": c} for k, l, a, c, _ in STAT_CATALOG],
        "matches": rows,
    }
